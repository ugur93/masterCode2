...
class NCNET1_GJOA2(NN_BASE):
    ...
    def __init__(self,n_depth=2,n_width=90,l2w=0.0001,dp_rate=0,seed=3014,output_act='relu',n_epoch=1500,DATA='GAS'):
        ...
        self.model_name ='GJOA_OIL_WELLS_{}_HUBER_MODEL_FINAL2_TESTDATA2'.format(DATA)# 'GJOA_OIL2S_WELLS_{}_D{}_W{}_L2{}_DPR{}'.format(loss, n_depth, n_width, l2w,dp_rate)
