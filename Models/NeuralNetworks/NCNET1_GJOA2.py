...
class NCNET1_GJOA2(NN_BASE):
    ...
    def __init__(self,maxnorm1=2,maxnorm2=2,maxnorm3=2,n_depth=2,n_width=50):

        self.model_name='NCNET2-QOIL_GAS_depth2_w100_mnconv_Gas'
    ...
    def initialize_model(self):
        ...
        for key in self.well_names:
            ...
            aux_input,input,merged_out,out=self.generate_input_module2(n_depth=n_depth, n_width=n_width,
    ...
    def generate_input_module(self,n_depth, n_width, l2_weight, name, n_input, thresholded_output, n_inception=0):
       ...
       # temp_output = Dropout(0.5)(temp_output)
        ...
        if thresholded_output:
            ...
            output_layer = Dense(1, init=INIT, W_constraint=maxnorm(self.maxnorm[2]),activation=self.output_layer_activation, bias=True)(temp_output)
