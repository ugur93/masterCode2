...
def validate_train_test_split(Data):
    ...
    output_cols=['C1_QGAS', 'C2_QGAS','C3_QGAS', 'C4_QGAS', 'B1_QGAS','B3_QGAS', 'D1_QGAS', 'GJOA_QGAS']
...
def validateRepeat(Data):
    ...
    print(s_rmse)
    print(s_r2)
    save_to_file(model_name + '_NREPEAT' + str(N_REPEAT)+'_results_QOIL_L7_r2',conf+s_rmse+s_r2+'\n NREPEAT: '+str(N_REPEAT))
